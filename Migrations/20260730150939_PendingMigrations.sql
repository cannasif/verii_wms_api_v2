...
BEGIN TRY
    ...
    -- Migration history kaydi bulunup fiziksel kolon eksik kalmis olsa da onar.
    IF COL_LENGTH(N'dbo.RII_WAREHOUSE', N'DefaultGoodsReceiptLocationId') IS NULL
        EXEC sys.sp_executesql N'ALTER TABLE [dbo].[RII_WAREHOUSE] ADD [DefaultGoodsReceiptLocationId] bigint NULL;';
    ...
    (
        ...
        EXEC sys.sp_executesql N'CREATE INDEX [IX_RII_WAREHOUSE_DEFAULT_GR_LOCATION]
    ...
    (
        ...
        EXEC sys.sp_executesql N'ALTER TABLE [dbo].[RII_WAREHOUSE] WITH CHECK
            ADD CONSTRAINT [FK_RII_WAREHOUSE_RII_LOCATION_DefaultGoodsReceiptLocationId]
            FOREIGN KEY ([DefaultGoodsReceiptLocationId]) REFERENCES [dbo].[RII_LOCATION] ([Id]) ON DELETE SET NULL;';
