/*
  ...
  Son migration: 20260804164101_AddProcurementSplitAwards
  Toplam migration: 77

  SSMS KULLANIMI
  1. Hedef WMS veritabanini secin (USE [VeritabaniAdi];)
  2. Bu scripti tek seferde calistirin
  3. Script idempotent'tir; daha once uygulanmis migration'lari atlar
  4. Son satirdaki dogrulama sorgusunu kontrol edin
