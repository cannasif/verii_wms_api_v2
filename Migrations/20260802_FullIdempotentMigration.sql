...
BEGIN
    BEGIN TRY
        ...
        -- Ayni batch'te yeni eklenen kolona statik referans verilmez.
        EXEC sys.sp_executesql N'
            UPDATE warehouse
        ...
        /*
          Yukaridaki uzlastirma bu migration'in Up islemlerinin tamamini yapar.
          History satiri eksikse burada yazilmali; aksi halde asagidaki EF
          idempotent blogu ayni kolonu ikinci kez eklemeye calisir.
        */
        IF NOT EXISTS
        (
