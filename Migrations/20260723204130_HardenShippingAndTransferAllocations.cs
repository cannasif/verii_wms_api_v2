...
(
    SELECT LTRIM(RTRIM(value)) SiparisNo
    FROM STRING_SPLIT(@SiparisNoCsv,',')
...
""");
        ...
        {
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS dbo.RII_FN_SH_LINE; DROP FUNCTION IF EXISTS dbo.RII_FN_SH_HEADER;");
