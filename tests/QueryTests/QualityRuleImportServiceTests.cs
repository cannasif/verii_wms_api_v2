...
public sealed class QualityRuleImportServiceTests
{
    ...
    private sealed class RecordingQualityService : IQualityService
    {
        ...
        public Task DecideInspectionAsync(long id, DecideQualityInspectionRequest request, long actor, bool canReleaseQuarantine, CancellationToken ct = default) => throw new NotSupportedException();
    }
}
