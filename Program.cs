...
using verii_wms_api_v2.Modules.ErpBalanceSync;
...
using verii_wms_api_v2.Modules.InventoryCount;
...
using verii_wms_api_v2.Modules.GeneratorProduction;
...
builder.Services.AddErpBalanceSyncModule(builder.Configuration);
...
builder.Services.AddInventoryCountModule();
...
builder.Services.AddGeneratorProductionModule();
