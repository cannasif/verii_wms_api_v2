namespace verii_wms_api_v2.Modules.DocumentSeries.Localization;

public sealed class DocumentSeriesResource;

public static class DocumentSeriesMessageKeys
{
    ...
    public const string IssuedSeriesDeleteBlocked = nameof(IssuedSeriesDeleteBlocked);
