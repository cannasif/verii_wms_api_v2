...
public sealed class VehicleCheckInHeaderConfiguration:BaseEntityConfiguration<VehicleCheckInHeader>
{
    protected override void ConfigureEntity(EntityTypeBuilder<VehicleCheckInHeader> b)
    {
        ...
        // Plaka bir aracın kimliği değil, arama anahtarıdır. Aynı araç aynı iş gününde
        // birden fazla bağımsız geliş yapabilir; geçmiş sorguları için non-unique indeks yeterlidir.
        b.HasIndex(x=>new{x.BranchCode,x.PlateNoNormalized,x.BusinessDate,x.CheckedInAtUtc})
            .HasDatabaseName("IX_RII_VEHICLE_CHECKIN_HEADER_PlateHistory");
