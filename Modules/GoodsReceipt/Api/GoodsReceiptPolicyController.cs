...
{
    [HttpGet] public async Task<IActionResult> Get([FromQuery]string branchCode,CancellationToken ct){await Require("WMS.GOODS_RECEIPT.SETTINGS.VIEW",ct);return Ok(ApiResponse<GoodsReceiptPolicyDto>.Ok(await service.GetAsync(branchCode,ct)));}
