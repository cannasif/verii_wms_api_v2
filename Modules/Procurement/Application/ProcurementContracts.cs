...
public sealed record ProcurementGridRow(
    long Id,
    string DocumentType,
    string DocumentNo,
...
public sealed record ProcurementDocumentDetail(
    ...
    DateOnly? DueDate,
    IReadOnlyList<ProcurementLineDetail> Lines,
    IReadOnlyList<ProcurementHistoryRow> History,
    IReadOnlyList<ProcurementSupplierParticipant>? Suppliers=null,
    long? RequestId=null,
    string? RequestNo=null,
    IReadOnlyList<ProcurementAttachmentRow>? Attachments=null,
    long? RfqId=null,
    string? RfqNo=null,
    long? QuoteId=null,
    string? QuoteNo=null,
    ...
    string? UpdatedByName=null,
    DateTime? UpdatedDate=null);
public sealed record ProcurementHistoryRow(string FromStatus,string ToStatus,long ActorUserId,string? Note,DateTimeOffset ChangedAtUtc,string? ActorUserName=null);
