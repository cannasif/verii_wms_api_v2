...
public sealed record WarehouseMirrorDto(long Id, string BranchCode, int WarehouseCode, string WarehouseName, DateTime? LastSyncDate, long? CreatedBy, DateTime? CreatedDate, long? UpdatedBy, DateTime? UpdatedDate);
public sealed record StockMirrorDto(long Id, string BranchCode, short BusinessUnitCode, string ErpStockCode, string StockName, string? ManufacturerCode, string? GroupCode, string? Code1, string? Code2, string? Code3, string? Code4, string? Code5, DateTime? LastSyncDate, long? CreatedBy, DateTime? CreatedDate, long? UpdatedBy, DateTime? UpdatedDate);
...
public sealed record YapCodeMirrorDto(long Id, string BranchCode, string ConfigurationCode, string Description, string? ConfigurableStockCode, long? StockId, DateTime? LastSyncDate, long? CreatedBy, DateTime? CreatedDate, long? UpdatedBy, DateTime? UpdatedDate);
