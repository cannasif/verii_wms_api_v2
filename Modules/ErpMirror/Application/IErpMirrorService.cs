...
public interface IErpMirrorService
{
    ...
    Task<MirrorSyncResult> SyncYapCodesAsync(CancellationToken cancellationToken = default);
    ...
    Task<PagedResponse<YapCodeMirrorDto>> GetYapCodesPagedAsync(PagedRequest request, CancellationToken cancellationToken = default);
}
