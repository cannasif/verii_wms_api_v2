...
public enum WarehouseInboundErpPostingPolicy { AfterReceipt = 1, AfterReceiptApproval = 2, AfterQualityApproval = 3, AfterAllApprovals = 4 }

public sealed class WarehouseInboundPolicy : BaseEntity
{
